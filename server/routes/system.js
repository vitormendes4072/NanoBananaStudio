...
import { generatedDir, dataDir, cutoutsDir, cropsDir, referencesDir, legacyUploadsDir, thumbsDir } from "../config.js";
import { normalizeConcurrency } from "../utils.js";

const _require = createRequire(import.meta.url);
const sharpPath = path.resolve(
  path.dirname(url.fileURLToPath(import.meta.url)),
  "../..", "node_modules", "@imgly", "background-removal-node", "node_modules", "sharp"
);
let sharp = null;
function getSharp() {
