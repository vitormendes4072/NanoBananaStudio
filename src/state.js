...
export const PROMPT_PRESETS = {
  product: {
    ...
    extraInstructions:
      'fundo limpo, destaque claro do produto, reflexos suaves e nitidez comercial',
  },
  fashion: {
  ...
  'portrait-post': {
    ...
    renderFocus: 'editorial',
    styleDirection:
      'composição vertical para feed, leitura forte no centro e enquadramento elegante',
    preserveDetails: 'sujeito principal dominante e área segura bem resolvida',
    extraInstructions:
      'resultado pensado para post retrato, com foco visual claro e bom aproveitamento vertical',
  },
  'story-reel': {
    aspectRatio: '9:16',
    renderFocus: 'advertising',
    ...
    extraInstructions:
      'resultado pensado para story ou reel, com área útil bem distribuída no eixo vertical',
  },
  banner: {
    aspectRatio: '16:9',
    renderFocus: 'advertising',
    ...
    extraInstructions:
      'resultado pensado para banner, hero ou capa horizontal com boa leitura panoramica',
  },
};
